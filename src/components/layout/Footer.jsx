...
const footerLinks = [
  ...
  { label: 'Property Areas', path: '/areas' },
  { label: 'Investment Guide', path: '/invest' },
        ...
        <div className="py-14 lg:py-16 flex flex-col lg:flex-row items-center justify-between gap-8" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div className="flex gap-3">
            ...
            {contactInfo.whatsapp && (
              <a href={`https://wa.me/${contactInfo.whatsapp}`} target="_blank" rel="noopener noreferrer" className="btn-outline btn-outline-light !py-3 flex items-center gap-2">
                <span>WhatsApp</span>
              </a>
            )}
          </div>
        ...
        <div className="py-14 lg:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-6">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-3 text-[13px] text-white/40" style={{ fontFamily: 'var(--font-body)', lineHeight: 1.8 }}>
              ...
              <p><a href={`tel:${(contactInfo.phone || '').replace(/\s+/g, '')}`} className="hover:text-white/70 transition-colors">{contactInfo.phone}</a></p>
              <p><a href={`mailto:${contactInfo.email}`} className="hover:text-white/70 transition-colors">{contactInfo.email}</a></p>
            </div>
          </div>
